...
NebulaUI.Derma.ScoreBack = GWEN.CreateTextureBorder(160, 0, 32, 32, 16, 16, 16, 16, dermaImage)
...
NebulaUI.Derma.InventorySub = {}
for k = 0, 7 do
    table.insert(NebulaUI.Derma.InventorySub, GWEN.CreateTextureNormal(k * 32, 32, 32, 32, invImage))
end
